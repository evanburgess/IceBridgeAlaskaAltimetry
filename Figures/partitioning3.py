...
ax = fig.add_axes([0.09,0.1,axwidth*2.35,0.8],frameon=False)

barlocs = [0,1,4,5,2,3]

b1,b2,b3 = ax.bar([0,1,2],[smb,flx,vol],yerr=[smberr,flxerr,volerr],width=width,color=[0.8,0.8,0.8],ecolor='k') # 
...
b1,b2,b3 = ax.bar(N.array([0,1,2])+width,[smb,flx,vol],yerr=[smberr,flxerr,volerr],width=width,color=[0.5,0.5,0.5],ecolor='k') # 
...
b1 = ax.bar([3],[unpart_vol],yerr=[unpart_volerr],width=width,color=[0.5,0.5,0.5],ecolor='k') # 

ax.annotate('SMB',[0+width,-4],rotation=90,horizontalalignment='center',verticalalignment='top',fontsize=10)
ax.annotate('Calving',[1+width,-16],rotation=90,horizontalalignment='center',verticalalignment='top',fontsize=10)
ax.annotate('Net',[2+width,-11],rotation=90,horizontalalignment='center',verticalalignment='top',fontsize=10)
ax.annotate('Unpartitioned',[3+width/2,-4],rotation=90,horizontalalignment='center',verticalalignment='top',fontsize=10)
font = matplotlib.font_manager.FontProperties(family='Arial', weight='bold', size=15)
ax.annotate('A.',[0.4,-49],horizontalalignment='center',verticalalignment='center',fontproperties=font)
ax.annotate('B.',[4.3,-49],horizontalalignment='center',verticalalignment='center',fontproperties=font)
...
pl1 = ax.bar(barlocs, d['gt'], color=colors, width=width,yerr=d['gterr'],error_kw=dict(ecolor='k'))

#PLOT settings
ax.axes.get_xaxis().set_visible(False)
ax.get_yaxis().tick_left()
plot_brace(ax,0.1,3+width,-35,5,up=False,annotate='Tidewater\nPartitioning',fontsize=10)
...
#PLOTTING Mass Balance(m w. eq.)
ax2 = fig.add_axes([0.75,0.1,axwidth,0.8],frameon=False)
pl1 = ax2.bar(barlocs, d['myr'], color=colors, width=width,yerr=d['myrerr'],error_kw=dict(ecolor='k'))
...
ax2.annotate('C.',[4.3,-1.2],horizontalalignment='center',verticalalignment='center',fontproperties=font)
