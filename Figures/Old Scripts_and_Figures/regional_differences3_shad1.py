...
colors = N.array([[200,200,200],[80,80,80],[179,203,252],[45,80,150],[189,237,166],[75,150,38]])/255.
#colorlist = N.tile(['brown','blue','green'],regions.size)#[N.where(N.array([b.size for b in boxdata2])!=0)]
#colorlist2 = N.tile(N.repeat(['brown','blue','green'],2),regions.size)
...
for by,beg,end,reg in zip(braceys,begs,ends,regionslab):plot_brace(ax3,beg,end,by,0.2,up=False,annotate=reg,fontsize=10)
braceys=[-3.2,-3,-2.8]
begs = begs[[0,2,5]]
ends = ends[[1,4,7]]
...
plt.show()
fig3.savefig("/Users/igswahwsmcevan/Papers/AK_altimetry/Figures/NewSuppfig1_to_map_shad1.jpg",dpi=300)