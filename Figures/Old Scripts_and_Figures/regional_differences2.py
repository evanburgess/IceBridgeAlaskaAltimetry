...
ax3 = fig3.add_axes([0.08,0.14,0.7,0.8],frameon=False)
ax = fig3.add_axes([0.87,0.14,0.1,0.8],frameon=False)
...
for i,bx in enumerate(pointdata):
    sca = ax3.scatter(pointxs[i],bx,zorder=4, lw=1.5,facecolors='none',edgecolor=colorlistdark[i])
    #sca.set_lw(0)
...
ax.annotate('B',[0.7,6],horizontalalignment='center',verticalalignment='center',fontproperties=font)
...
ax.add_artist(Line2D((xmin, xmax), (ymin, ymin), color='k', linewidth=3,ls='--'))
