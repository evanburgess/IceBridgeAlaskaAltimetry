...
#REGRESSION SIG
ax.text(0.7,0.68,"r=%1.2f, sig=%1.3f"%(corr[0],corr[1]),fontsize=11,transform=ax.transAxes,ha='right')
...
va = ['top','bottom','top','bottom','top','top','top']
...
plt.show()
fig.savefig("/Users/igswahwsmcevan/Papers/AK_altimetry/Figures/flux_vs_smb2_shad.jpg",dpi=300)
