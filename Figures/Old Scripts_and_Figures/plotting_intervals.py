...
data = GetLambData(longest_interval=True,as_object=True, orderby="ergi.region,ergi.name")
...
net = N.array(net2)
outputfile="/Users/igswahwsmcevan/Papers/AK_altimetry/Figures/Longest_Interval_All_Glaciers_intervals2.jpg"
#outputfile=None
show=True
annotate=True
colorby=net
